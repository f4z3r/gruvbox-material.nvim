...
return {
  ...
  DiagnosticVirtualTextWarn = { link = "VirtualTextInfo" },
  DiagnosticVirtualTextInfo = { link = "VirtualTextInfo" },
  DiagnosticVirtualTextHint = { link = "VirtualTextInfo" },
  ...
  DiagnosticFloatingOk = { link = "Success" },
